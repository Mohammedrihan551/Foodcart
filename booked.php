...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  if (isset($_POST["datesubmit"])) {
    ...
    echo "<tr><th style='color:rebeccapurple;font-weight:bold' scope='row' colspan='9'>Number of order placed on " . $date . " is " . $nrow . "</th></tr>";
    echo "<tr><th style='color:rebeccapurple;font-weight:bold' scope='row' colspan='9'> Total Number of order(quantity) placed on " . $date . " is " . $tot . "</th></tr>";
  ...
  <table class='table table-bordereless table-hover table-condensed small'>
    ...
    echo "<tr><th style='color:rebeccapurple;font-weight:bold' scope='row' colspan='9'> Total Number of order(quantity) placed on is " . $tot . "</th></tr>";
  ...
  echo "<tr><th style='color:rebeccapurple;font-weight:bold' scope='row' colspan='9'>Number of order placed on  is " . $nrow . "</th></tr>";
  echo "<tr><th style='color:rebeccapurple;font-weight:bold' scope='row' colspan='9'> Total Number of order(quantity) placed is " . $tot . "</th></tr>";
